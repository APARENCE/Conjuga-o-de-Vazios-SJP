...
export default function AnaliseCheios({ containers }: AnaliseCheiosPageProps) {
      ...
      <div className="sticky top-0 z-40 bg-background pb-2 border-b border-border/50 shadow-sm -mx-4 px-4">
        <div className="space-y-2">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2">
            <div>
              <h1 className="text-2xl font-bold tracking-tight">Análise de Containers-Cheios</h1>
              <p className="text-muted-foreground text-sm mt-1">
                Visualização e estatísticas detalhadas dos containers cheios CAS
              </p>
            </div>
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          {(selectedChart === "all" || selectedChart === "armador") && (
            <ChartCard
              title="Containers Cheios por Armador"
          ...
          {(selectedChart === "all" || selectedChart === "status") && (
            <ChartCard
              ...
              description="Proporção de containers cheios por status"
              icon={PieChartIcon}
            >
              <ChartContainer config={chartConfig} className={`h-[${chartHeight}px]`}>
                <ResponsiveContainer width="100%" height="100%">
          ...
          {(selectedChart === "all" || selectedChart === "depot") && (
            <ChartCard
              title="Containers Cheios por Depot de Devolução"
